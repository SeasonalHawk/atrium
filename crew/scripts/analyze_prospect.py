#!/usr/bin/env python3
"""
Prospect Analyzer — Atrium (adapted from ai-sales-team-claude)
...
def fetch_url(url, timeout=10):
    ...
    headers = {"User-Agent": "Mozilla/5.0 (compatible; AtriumProspectAnalyzer/1.0)"}
...
def main():
    parser = argparse.ArgumentParser(
        description="Prospect Analyzer — fetch and analyze a company website for prospect intelligence.",
