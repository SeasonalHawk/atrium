# Atrium Competitive Intelligence
...
```
/atrium competitors <url>
```

Where `<url>` is the prospect company's website URL. The skill detects what the prospect currently uses and builds atrium-focused battle cards for each detected solution.
